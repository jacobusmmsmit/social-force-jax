...
def no_nan_gradients():
    ...
    width = 5.0
    height = 3.0
    x0 = ped.two_groups_datum(key, N, width, 0.66 * height)
    xs = x0[:, 0:2]
    ...
    ped_ped_dist = 0.0
    V_dist_grad, V_str_grad, V_shape_grad = jax.jacrev(ped.V, (0, 1, 2))(
    ...
    VPrime_dist_grad, VPrime_str_grad, VPrime_shape_grad = jax.jacrev(ped.V, (0, 1, 2))(
    ...
    tpr_xi_grad, tpr_xs_grad, tpr_str_grad, tpr_shape_grad = jax.jacrev(
        ped.total_pedestrian_repulsion, (0, 1, 2, 3)
    ...
    ptpr_xs_grad, ptpr_str_grad, ptpr_shape_grad = jax.jacrev(
        ped.pairwise_total_pedestrian_repulsion, (0, 1, 2)
    ...
    vseg_point_grad, vseg_segment_grad = jax.jacrev(
        ped.closest_point_to_vsegment, (0, 1)
    )(point, segment)
